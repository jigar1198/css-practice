...
import nuxt_plugin_plugin_55570a4a from 'nuxt_plugin_plugin_55570a4a' // Source: .\\components\\plugin.js (mode: 'all')
import nuxt_plugin_bootstrapvue_62d99fad from 'nuxt_plugin_bootstrapvue_62d99fad' // Source: .\\bootstrap-vue.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof nuxt_plugin_plugin_55570a4a === 'function') {
    await nuxt_plugin_plugin_55570a4a(app.context, inject)
  }

  if (typeof nuxt_plugin_bootstrapvue_62d99fad === 'function') {
    await nuxt_plugin_bootstrapvue_62d99fad(app.context, inject)
  }
